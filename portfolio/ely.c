...
void ely_light(double p[2], double size)
{
    G_rgb(1, 1, 1);
    G_fill_circle(p[0], p[1], size);
...
void ely_clear(double p[2], double size)
{
  G_rgb(1, 1, 1);
  G_clear();
  ely(p, size);
...
void ely_look_up(double p[2], double size)
{
    G_rgb(0, 0, 0);
    G_fill_circle(p[0], p[1], size);
    ...
    glasses_size = size / 3.0;
    glasses_left[0] = p[0] - glasses_sep;
    glasses_left[1] = p[1] + glasses_size;
    glasses_right[0] = p[0] + glasses_sep;
    glasses_right[1] = p[1] + glasses_size;
    G_rgb(1, 1, 1);
    G_fill_circle(glasses_left[0], glasses_left[1], glasses_size);
    G_fill_circle(glasses_right[0], glasses_right[1], glasses_size);
}

void ely_look_down(double p[2], double size)
{
    G_rgb(0, 0, 0);
    G_fill_circle(p[0], p[1], size);
...
void ely_eyes_closed(double p[2], double size)
{
    G_rgb(0, 0, 0);
    G_fill_circle(p[0], p[1], size);
...
void ely_eyes_flash(double p[2], double size)
{
    G_rgb(0, 0, 0);
    G_fill_circle(p[0], p[1], size);
